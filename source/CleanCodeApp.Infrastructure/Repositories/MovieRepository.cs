...
public class MovieRepository : IMovieRepository
{
    private static readonly Movie[] movies = [
        new Movie("Godzilla x Kong: The New Empire", TimeSpan.FromHours(2), "Godzilla and the almighty Kong face a colossal threat hidden deep within the planet, challenging their very existence and the survival of the human race."),
        ...
        new Movie("หอแต๋วแตก แหกสัปะหยด", TimeSpan.FromHours(1.75), "เจ๊แต๋ว อาโคย และ แพนเค้ก กับภาคสุดท้ายของหนังในตำนานของคนที่โตมากับ 'หอแต๋วแตก' เดินทางมาถึงภาค 10 เรื่องราวแปลกๆ ทั้งผี ทั้งคน ที่เกิดขึ้นในหมู่บ้าน 'สัปะหยด' แห่งนี้ เกิดจากใคร หรืออะไรกันแน่ ผีร้ายที่ว่าแน่ จะมาเก่งกว่าตัวมารดาของแทร่ได้ยังไง ฮาอาละวาดพร้อมกันในโรงภาพยนตร์"),
